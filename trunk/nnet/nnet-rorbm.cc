...
void RoRbm::ProgagateFnc(const CuMatrix<BaseFloat> &vt_cn,
...
void RoRbm::Inference(const CuMatrix<BaseFloat> &vt_cn) {
  ...
  s_mu.AddColSumMat(0.05, s_, 0.95);
...
void RoRbm::CollectPositiveStats(const CuMatrix<BaseFloat> &vt_cn) {
  ...
  e_pos_.AddColSumMat(1.0, hs_, 0.0);
...
void RoRbm::CollectNegativeStats() {
  ...
  e_neg_.AddColSumMat(1.0, fp_hs_, 0.0);
