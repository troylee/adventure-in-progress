...
template<typename Real> inline void cuda_apply_pow(dim3 Gr, dim3 Bl, Real *mat, Real pow, MatrixDim d) { KALDI_ERR << __func__ << " Not implemented!"; }
...
template<> inline void cuda_apply_pow<float>(dim3 Gr, dim3 Bl, float *mat, float pow, MatrixDim d) { cudaF_apply_pow(Gr,Bl,mat,pow,d); }
...
template<> inline void cuda_apply_pow<double>(dim3 Gr, dim3 Bl, double *mat, double pow, MatrixDim d) { cudaD_apply_pow(Gr,Bl,mat,pow,d); }
